package com.devc.lab.audios.ads;
...
public class SubAdlibAdViewAdmob extends SubAdlibAdViewCore {
    ...
    protected String admobID = AdConstants.admob_banner_key;
    protected static String admobInterstitialID = AdConstants.admob_interstitial_key;
